...
const ReceivedResponseScreen = ({ navigation }) => {
    ...
    <SafeAreaView>
      {user ? (
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <Card
                ...
                onPress={() =>
                  navigation.navigate("ReceivedResponseDetail", item)
                }
              />
            )}
        ...
        <View style={{ justifyContent: "center", marginTop: hp("40%") }}>
          ...
          >
            There is No Responded Messages
          </Text>
        </View>
      )}
    </SafeAreaView>
...
export default ReceivedResponseScreen;
