        ...
        <View style={styles.textInputMaiView}>
          ...
          <View style={styles.textInputSubViews}>
            <TextInputCom
              ...
              onChangeText={() => setPhoneNumber(value)}
            />
          </View>
          ...
          <View style={styles.textInputSubViews}>
            <TextInputCom
              ...
              borderWidth={2}
              borderRadius={16}
              onChangeText={() => setNeighborhood(value)}
            />
          </View>
          <View style={styles.textInputSubViews}>
            <TextInputCom
          ...
          <View style={styles.textInputSubViews}>
            <TextInputCom
              ...
              borderWidth={2}
              borderRadius={16}
              onChangeText={() => setMedicalCondition(value)}
            />
          </View>
          <View style={styles.textInputSubViews}>
            <TextInputCom
